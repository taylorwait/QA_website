...
EMAIL_HOST = 'smtp.yeah.net'                     # SMTP地址 例如: smtp.126.com
EMAIL_PORT = 25                       # SMTP端口 例如: 25
EMAIL_HOST_USER = 'ceshihahu@yeah.net'                  # 我自己的邮箱 例如: taylorwait@163.com
EMAIL_HOST_PASSWORD = 'ceshihahu000000'             # 我的邮箱密码 例如  xxxxxxxxx
