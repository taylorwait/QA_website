...
class Category(models.Model):
    ...
    class Meta:
        ...
        app_label = string_with_title('blog', u"网站管理")
...
class Article(models.Model):
    ...
    category = models.ForeignKey(Category, verbose_name=u'关键字')
...
class Column(models.Model):
    ...
    article = models.ManyToManyField(Article, verbose_name=u'话题')
    status = models.IntegerField(default=0, choices=STATUS.items(),
                                 verbose_name='状态')
...
class Carousel(models.Model):
    ...
    article = models.ForeignKey(Article, verbose_name=u'话题')
    create_time = models.DateTimeField(u'创建时间', auto_now_add=True)
